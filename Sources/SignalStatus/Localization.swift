...
enum L10n {
    ...
    private static let simplifiedChinese: [String: String] = [
        ...
        "Traffic is pinned to the shown modem interface and the final result must report that same interface. Live rates use interface counters and may include other traffic; final rates come from Ookla Speedtest CLI.": "流量已固定到所示调制解调器接口，最终结果也必须报告同一接口。实时速度来自接口计数器，可能包含其他流量；最终速度来自 Ookla Speedtest CLI。",
        ...
        "Standard": "标准",
        "Wide": "宽",
        "More information": "详细说明",
        "Radio access mode change failed": "无线接入模式切换失败",
        "OK": "确定",
        ...
        "NR bands": "NR 频段",
        "LTE bands": "LTE 频段",
        "Apply NR lock": "应用 NR 锁定",
        "Apply LTE lock": "应用 LTE 锁定",
        "Select at least one band.": "请至少选择一个频段。",
        "Reading bands…": "正在读取频段…",
        "Selected": "已选择",
        "Not selected": "未选择",
